...
import com.shiva.learning.kotlinyoutube.databinding.ActivityCourseLessonBinding
...
class CourseLessonActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        courseUrl = intent.getStringExtra("COURSE_URL").toString()
        println("Attempting to load $courseUrl")
    ...
    private fun loadWebView() {
        binding.infoTV.text = ""
        binding.webView.loadUrl(courseUrl)
